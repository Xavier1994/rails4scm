class Scm::Item::Query::ItemChgDepictTwoController < ApplicationController
  ...
  def index
    ...
    @clos = clos.split(",")
    @chgdata = ChgSourceRecord.find(:all,:conditions =>["chg_no =? ",@configure_chg_no])
    @message = "";

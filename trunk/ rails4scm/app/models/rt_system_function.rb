class RtSystemFunction < ActiveRecord::Base
      ...
      def findUserSystemFunction(operid)
        sql = "select distinct aa.func_id,ab.func_name,ab.target,ab.func_group_id,ab.func_param,ab.ORDER_COL "
        ...
        sql += "where a.PERSON_CLASS_CODE=b.PERSON_CLASS_CODE and a.OPER_ID=c.OPER_ID and a.oper_id='" + operid + "') order by ORDER_COL"

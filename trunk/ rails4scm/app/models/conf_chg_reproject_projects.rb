class ConfChgReprojectProjects < ActiveRecord::Base
  ...
  def findByEvencodeConfcodeConfver(event_code,configure_code,configure_ver)
    sql = "SELECT  CONF_CHG_REPROJECT_PROJECTS.ID CID,CONF_CHG_REPROJECT_PROJECTS.EVENT_CODE ,CONF_CHG_REPROJECT_PROJECTS.CONFIGURE_CODE ,CONF_CHG_REPROJECT_PROJECTS.CONFIGURE_VERS ,CONF_CHG_REPROJECT_PROJECTS.PROJECT_CODE ,CONF_CHG_REPROJECT_PROJECTS.CAN_USE_FLAG ,PROJECT_MSG.PROJECT_NAME     "
